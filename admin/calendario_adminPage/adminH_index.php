...
<body>
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul class="nav-list primary-nav">
                   ...
                   <li class="nav-item">
                    <a href="../reservas_adminPage/reservas.php" class="nav-link">
   ...
   <!-- Modal Visualizar Reserva -->
            ...
            <div class="modal-content mx-auto" style="width:550px">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" id="formCadEvento">
                        ...
                        <button type="submit" name="btnCadEvento" class="btn btn-success" id="btnCadEvento">Reservar</button>
    ...
    <script src="admin_calendario.js"></script>
