    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        socket.on('nuevoEvento', function (evento) {
            console.log('Evento recibido desde el servidor:', evento);
            if (evento.estado === 'aprobada') {
                console.log('Nuevo evento aprobado, agregando al calendario:', evento);
        ...
        if (formCadEvento){
            ...
            formCadEvento.addEventListener("submit", async (e) => {
                ...
                if (diffHours > 2 || diffMin < 30) {
                    alert("La reserva tiene que ser menor a 2h y mayor o igual a 30min.");
                    return; // Detener el envío del formulario
                }

                btnCadEvento.value = "Enviando...";
